...
<div class="h-full flex flex-col bg-slate-50 dark:bg-background-dark overflow-hidden">
    ...
    <main class="flex-1 overflow-hidden relative">
        <form id="moment-form" method="POST" action="{{ route('admin.moments.update', $moment) }}" enctype="multipart/form-data" class="h-full flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden">
            @csrf
            @method('PUT')
